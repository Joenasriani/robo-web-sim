...
export default function OnboardingStrip() {
  ...
  return (
    ...
    >
      ...
      <ol className="flex items-center gap-3 min-w-0" aria-label="Steps to use the simulator">
        {STEPS.map((step, i) => (
      ...
      <button
        ...
        className="ml-auto shrink-0 text-blue-400 hover:text-white transition-colors text-sm leading-none"
        title="Dismiss"
      >
        ✕
      </button>
